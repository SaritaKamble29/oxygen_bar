<?php
  ...
  // Updated join query (fetch category + supplier)
  $products = find_all_products_with_category_supplier();
?>
          ...
          <tbody>
            <?php foreach ($products as $product): ?>
              <tr>
                ...
                <td class="text-center"><?php echo remove_junk($product['volume']); ?></td>
